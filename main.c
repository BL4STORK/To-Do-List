//CD C:\Users\gabriel.de-brito\Documents\GitHub\To-Do-List-SDL
//SET PATH=C:\mingw64\bin;%PATH%
//gcc -std=c17 main.c -IC:\Users\gabriel.de-brito\Documents\GitHub\To-Do-List-SDL\SDL2\include -LC:\Users\gabriel.de-brito\Documents\GitHub\To-Do-List-SDL\SDL2\lib -Wall -lmingw32 -lSDL2main -lSDL2 -lSDL2_ttf -o main
...
int main(int argc, char *argv[]) {
    ...
    while (running) {
        ...
        SDL_SetRenderDrawColor(rend, 0, 184, 190, 255);
        SDL_RenderFillRect(rend, &to_do);
        SDL_SetRenderDrawColor(rend, 139, 0, 234, 255);
        SDL_RenderFillRect(rend, &in_work);
        SDL_SetRenderDrawColor(rend, 190, 0, 173, 255);
